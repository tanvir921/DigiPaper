...
class LatestNewses extends StatefulWidget {
  const LatestNewses({super.key});


  @override
  State<LatestNewses> createState() => _LatestNewsesState();
}

class _LatestNewsesState extends State<LatestNewses>
    with AutomaticKeepAliveClientMixin<LatestNewses>{
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        title: const Text('Latest Newses', style: TextStyle(
          fontSize: 22,
        ),),
        centerTitle: true,
      ),
