                            ...
                            return Container(
                              ...
                              child: Center(
                                child: Padding(
                                  ...
                                  child: Text(
                                    FirstLaterCapitalizatoner.capitalizeFirstLetter(widget.category[i].toString(),),
                  ...
                  child: Padding(
                    ...
                    child: Column(
                      children: [
                                ...
                                children: [
                                  ...
                                  Center(
                                    ...
                                    widget.creator.isEmpty
                                        ? 'Admin'
                                        : widget.creator[0].toString().length > 10
                            ...
                            Container(
                              ...
                              child: Row(
                                children: [
                                  ...
                                  Center(
                                    child: Text(
                                      FirstLaterCapitalizatoner.capitalizeFirstLetter(widget.creator.isEmpty
                                          ? 'Unspecified'
                                          : widget.country[0].toString().length > 10
                        ...
                        Container(
                          margin: const EdgeInsets.only(top: 10),
                          child: Text(widget.detailNews , style: const TextStyle(
                            color: Colors.grey,
                            fontSize: 15,
